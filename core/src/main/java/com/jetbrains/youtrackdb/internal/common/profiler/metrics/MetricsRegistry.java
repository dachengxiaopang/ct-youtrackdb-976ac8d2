...
import com.jetbrains.youtrackdb.internal.common.profiler.metrics.MetricScope.Class;
 ...
 * {@code com.jetbrains.youtrackdb.metrics:scope=Global}, database metrics are registered under the
 * name {@code com.jetbrains.youtrackdb.metrics:scope=Database,databaseName=<databaseName>}.
 * <p>
    ...
    public void register(MBeanServer server, String properties) {
      ...
      try {
        final var objectName =
            new ObjectName("com.jetbrains.youtrackdb.metrics:" + properties);
